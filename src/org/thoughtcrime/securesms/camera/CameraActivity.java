                                                                                   ...
                                                                                   ScribbleFragment.Controller
{
  ...
  public void onBackPressed() {
    ...
    if (editorFragment != null && editorFragment.isEmojiKeyboardVisible()) {
      ...
      if (editorFragment != null && captureUri != null) {
        ...
        PersistentBlobProvider.getInstance(this).delete(this, captureUri);
        captureUri = null;
      }
      super.onBackPressed();
  ...
  public void onImageCaptured(@NonNull byte[] data) {
    ...
    LifecycleBoundTask.run(getLifecycle(), () -> {
      return PersistentBlobProvider.getInstance(this).create(this, data, MediaUtil.IMAGE_JPEG, null);
    }, uri -> {
      Log.i(TAG, "Fast image stored: " + uri.toString());
      captureUri = uri;
      ...
      result.addListener(new AssertedSuccessListener<Boolean>() {
        ...
        public void onSuccess(Boolean result) {
          ScribbleFragment fragment = ScribbleFragment.newInstance(uri, dynamicLanguage.getCurrentLocale(), Optional.of(transport));
